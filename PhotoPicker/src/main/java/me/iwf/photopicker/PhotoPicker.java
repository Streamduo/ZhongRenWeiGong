...
public class PhotoPicker {
  ...
  public final static int DEFAULT_INIT_COUNT    = 0;
  ...
  public final static String EXTRA_INIT_COUNT       = "INIT_COUNT";
  ...
  public static class PhotoPickerBuilder {
    ...
    public PhotoPickerBuilder setInitPhotoCount(int photoCount) {
      mPickerOptionsBundle.putInt(EXTRA_INIT_COUNT, photoCount);
      return this;
    }
