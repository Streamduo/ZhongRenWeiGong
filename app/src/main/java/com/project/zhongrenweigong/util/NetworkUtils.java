...
public class NetworkUtils {
    ...
    public static boolean isWifi(@Nullable Context context) {
        if (context == null) {
            return false;
        }
        ConnectivityManager manager = (ConnectivityManager) context.getSystemService(Context.CONNECTIVITY_SERVICE);
    ...
    public static boolean isMobile(@Nullable Context context) {
        if (context == null) {
            return false;
        }
        ConnectivityManager manager = (ConnectivityManager) context.getSystemService(Context.CONNECTIVITY_SERVICE);
    ...
    public static String getConnectWifiSsid(@Nullable Context context){
