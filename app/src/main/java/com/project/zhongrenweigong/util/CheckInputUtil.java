...
/**
 * Created by cj on 2016/1/14 0014.
 */
...
//        Ai = Ai + strVerifyCode;
        ...
        if (IDStr.length() == 18) {
            String s = IDStr.substring(17);
            if (s.equalsIgnoreCase("x") || isNumeric(s)) {
    ...
    private static boolean isDataFormat(String str) {
        ...
        String regxStr =
                "^((\\d{2}(([02468][048])|([13579][26]))[\\-\\/\\s]?" +
                        ...
                        "?[469])|(11))[\\-\\/\\s]?((0?[1-9])|([1-2][0-9])|(30)))|(0?2[\\-\\/\\s]?" +
...
//    4、判断字符串是否是手机号
    ...
    /**
     * 判断是否是手机号 ^(0|86|17951)?(916|13[0-9]|15[012356789]|17[0678]|18[0-9]|14[57])[0-9]{8}$
     *
     * @param phone
     * @return
     */
    ...
    public static boolean checkPhoneForLogin(String phone) {
        Pattern pattern = Pattern
                .compile("916\\d{8}|1\\d{10}");
        Matcher matcher = pattern.matcher(phone);

        return matcher.matches();
    }

    public static boolean checkPassword(String phone) {
        Pattern pattern = Pattern
