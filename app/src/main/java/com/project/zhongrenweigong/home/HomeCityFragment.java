...
import com.project.zhongrenweigong.home.viewholder.HomeCityHeader;
 ...
 * 意图：
 */
public class HomeCityFragment extends BaseFragment<HomeCityPresent> {
    ...
    private HomeCityHeader homeCityHeader;

    public static HomeCityFragment getInstance(int index) {
        HomeCityFragment homePageXinXiFragment = new HomeCityFragment();
    ...
    public void initView() {
        ...
        homeRecommedListAdapter.setHeaderView(homeCityHeader.headerView);
    ...
    private void initTop(){
        homeCityHeader = new HomeCityHeader(getContext(),getActivity());
    }
    ...
    @Override
    public HomeCityPresent bindPresent() {
        return new HomeCityPresent();
    }
