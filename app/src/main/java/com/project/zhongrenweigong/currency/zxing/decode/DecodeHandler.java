...
package com.project.zhongrenweigong.currency.zxing.decode;
...
//		data = rotatedData;
		...
		Log.d(TAG, "decode: 解码时间" + (System.currentTimeMillis() - start) +" ms");
		...
		if (rawResult != null) {
			...
			long end = System.currentTimeMillis();
			Log.d(TAG, "NOT Found barcode in " + (end - start) + " ms");
