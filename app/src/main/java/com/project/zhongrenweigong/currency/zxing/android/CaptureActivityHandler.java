...
import com.project.zhongrenweigong.currency.zxing.camera.CameraManager;
import com.project.zhongrenweigong.currency.zxing.decode.DecodeThread;
import com.project.zhongrenweigong.currency.zxing.view.ViewfinderResultPointCallback;
...
//			Bitmap barcode2 = null;
//			if (bundle2 != null) {
//				byte[] compressedBitmap = bundle2
//						.getByteArray(DecodeThread.BARCODE_BITMAP);
//				if (compressedBitmap != null) {
//					barcode2 = BitmapFactory.decodeByteArray(compressedBitmap,
//							0, compressedBitmap.length, null);
//					// Mutable copy:
//					barcode2 = barcode2.copy(Bitmap.Config.ARGB_8888, true);
//				}
//			}
//			activity.handleDecodeFailed((Result) message.obj, barcode2);
			break;
