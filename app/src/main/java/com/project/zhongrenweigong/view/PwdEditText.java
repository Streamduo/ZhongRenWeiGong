...
public class PwdEditText extends AppCompatEditText {
    ...
    private void setAttrs(AttributeSet attrs) {
        ...
        if (t != null) {
            textLength = t.getInt(R.styleable.PwdEditText_textLength,4);
            ...
            Round = t.getDimensionPixelSize(R.styleable.PwdEditText_round, (int)TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP,1,getResources().getDisplayMetrics()));
            ...
            textSize = t.getDimensionPixelSize(R.styleable.PwdEditText_textSize, (int)TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP,16,getResources().getDisplayMetrics()));
            checkedColor = t.getColor(R.styleable.PwdEditText_checkedColor,0xfff2f2f4);
            defaultColor = t.getColor(R.styleable.PwdEditText_defaultColor,0xfff2f2f4);
            backColor = t.getColor(R.styleable.PwdEditText_backColor,0xfff2f2f4);
            textColor = t.getColor(R.styleable.PwdEditText_textColor,0xFF222222);
