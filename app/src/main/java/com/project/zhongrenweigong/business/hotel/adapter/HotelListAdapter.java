package com.project.zhongrenweigong.business.hotel.adapter;
 ...
 * 意图：
 */
public class HotelListAdapter extends BaseQuickAdapter<IndustryDataBean,BaseViewHolder> {

    public HotelListAdapter(int layoutResId) {
        super(layoutResId);
    }
