 ...
 * 意图：
 */
public class InsdustryListAdapter extends BaseQuickAdapter<IndustryDataBean, BaseViewHolder> {

    public InsdustryListAdapter(int layoutResId) {
        super(layoutResId);
    }
    ...
    protected void convert(BaseViewHolder helper, IndustryDataBean item) {
        ...
        helper.setVisible(R.id.te_mechanism_phone, true);
    }
}
