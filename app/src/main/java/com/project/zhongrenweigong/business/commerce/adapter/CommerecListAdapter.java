package com.project.zhongrenweigong.business.commerce.adapter;
 ...
 * 意图：
 */
public class CommerecListAdapter extends BaseQuickAdapter<IndustryDataBean,BaseViewHolder> {

    public CommerecListAdapter(int layoutResId) {
        super(layoutResId);
    }
